...
async function setAvatarFrame() {
    ...
    if (response.data.discord_status == 'offline') {
        ...
        if (response.data.discord_status == 'dnd') 
        activity2.innerHTML = "do not disturb";
        activity2.style.cssText = 'color: #ed4245; opacity: 1;';
    ...
    switch (response.data.discord_status) {
        ...
        case 'idle':
            ...
            (response.data.discord_status == 'idle') 
            activity2.innerHTML = "away";
            activity2.style.cssText = 'color: #faa81a; opacity: 1;';
